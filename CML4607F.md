...
- In case of (ii ) consent c a n be given by ratification. But must still be in writing (signed) before two witnesses.
...
- What the limping contract means is that the minor c a n choose (with the assistance of the guardian) whether to enforce the contract (`ratification`) or not to enforce the contract (`repudiation`).
...
- The offeror c a n always stipulate that acceptance will only b e valid once he has read it.
