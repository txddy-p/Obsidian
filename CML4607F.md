...
### Legislation
- gives effect to societal agreements
...
- Magistrate courts
	...
	- They may only hear matters sitting as a court of first instance (MCs cannot hear appeals or reviews)
...
- The general principle in civil matters is that the plaintiff (<a style="color:green"> brings claim</a>) must follow the defendant to their court
	- So a plaintiff has to bring the matter to the court in which the defendant (<a style="color:green"> person being sued</a>) resides or has its principal place of business
...
1. Establishment of bare minimum conditions of employment
2. Encouragement of collective bargaing
3. Concept of fair dismisal
4. Protection against unfair dismisal
5. Special dispute resolution
6. Introduction of the minimum wage act
...
- Social security rights
	- These are governed by numerous statutes
...
- Different tests developed by the courts:
	- <a style="color:green">Control test</a>
		- Employee if someone else has control over them like working hours, signing in etc
	- <a style="color:green">Organisation test</a>
		- Is the person part of the employers organisation, do they have an office, tools provided by the organisation
	- <a style="color:green">Dominant impression test</a>
		- weighs factors of being an employee vs being a contractor
		- contains both the control and organisation tests
...
- Misrepresentation, puffery and the truth
	- employee can be dismissed for misrepresantation/dishonesty and the courts will uphold the dismisal as fair
...
- Employment contracts can be for:
	...
	- Indefinite period
- employment contract for the completion of a specific task or specific period, contract terminates automatically and theres no benefits
...
2. Cancellation
	...
	- Repudiation means person has shown intent to not be bound to the contract any longer, this is a form of a breach
3. Agreement
	- Note: constructive dismissal
	- Constructive dismissal is when an employee is forced to resign due to working conditions by the employer (they basically want to get rid of you) and the emploee can claim for unfair dismissal if they can prove they resigned not of free will
	- Incapacity hearing
4. Death
	- If employee/er dies then the employment ends except for corporate relationship 
5. Insolvency
	- Insolvency of employer/company may end the employment relation but that of an employee doesn't
6. Impossibility of performance
	1. Links to disability
...
- LRA provides for 3 possible remedies for unfair dismissal (week 6):
	...
	- Compensation max 12 months remuneration
...
- legal persons have full contractual capacity and can enter into any contract they wish without any limitations
